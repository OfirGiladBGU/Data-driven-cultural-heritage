...
parser.add_argument('--model', type=str, default = 'MBD_SHAPENET',  help='optional reload model path')
...
dir_name, logname  = save_paths(opt.model, "train_MBD", "ShapeNetDataset", "hole_residual")
